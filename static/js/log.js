$(function () {
    ...
    slider.noUiSlider.on("slide", function(handle){
    ...
    //     if($(e.target).find('.noUi-handle-upper').hasClass("noUi-active")) sliderEndHandleMoved=true
    // });

    // function sliderEndHandleMoved(){

        
        
    //     // console.log('slider.dataset.min', fromUnix(slider.dataset.min).toString(), slider.dataset.min)
    //     console.log('currentEndDate', fromUnix(currentEndDate).toString(), currentEndDate)
    //     console.log('smax', fromUnix(smax).toString(),  smax)
    //     console.log('slider.dataset.end', fromUnix(slider.dataset.end).toString(), slider.dataset.end)

    //     return currentEndDate !== slider.dataset.end
    // }


    // const updateIndicator = document.getElementById('updateIndicator');
    // updateIndicator.style.color = "red";

    // $(window).on("unload", function() {
    //     sessionStorage.removeItem('handleMoved'); 
    // });


        // console.log('slider.dataset.min', fromUnix(slider.dataset.min).toString(), slider.dataset.min)
        // console.log('currentEndDate', fromUnix(slider.dataset.max).toString(), slider.dataset.max)
        // console.log('smax', fromUnix(slider.dataset.start).toString(), slider.dataset.start)
        // console.log('slider.dataset.end', fromUnix(slider.dataset.end).toString(), slider.dataset.end)
